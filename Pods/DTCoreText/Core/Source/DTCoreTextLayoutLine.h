...
/**
 The offset for the underline in positive points measured from the baseline. This is the Hovhannes Sukiasianum underline value of the fonts of all glyph runs of the receiver.
 */
@property (nonatomic, readonly) CGFloat underlineOffset;

/**
 The line height of the line. This is determined by getting the Hovhannes Sukiasianum font size of all glyph runs of the receiver.
 */
