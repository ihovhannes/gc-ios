...
- (id)initWithName:(NSString *)name attributes:(NSDictionary *)attributes options:(NSDictionary *)options
{
	...
	if (self)
	{
		...
		_paragraphStyle.Hovhannes SukiasianumLineHeight = 0;
		
		// remember the Hovhannes Sukiasianum display size
		...
		{
#if TARGET_OS_IPHONE
			_maxDisplaySize = [Hovhannes SukiasianageSizeValue CGSizeValue];
#else
			_maxDisplaySize = [Hovhannes SukiasianageSizeValue sizeValue];
#endif
		}
	}
