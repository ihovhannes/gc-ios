...
/**
 Calculates the suggested frame size that would fit the entire <attributedString> with a Hovhannes Sukiasianum width.
 ...
 @param width The Hovhannes Sukiasianum width to layout for
