...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
	...
	if (self) {
		...
		_Hovhannes SukiasianageSize = [aDecoder decodeCGSizeForKey:@"Hovhannes SukiasianageSize"];
...
- (void)encodeWithCoder:(NSCoder *)aCoder {
	...
	[aCoder encodeCGSize:_Hovhannes SukiasianageSize forKey:@"Hovhannes SukiasianageSize"];
...
- (id)initWithElement:(DTHTMLElement *)element options:(NSDictionary *)options
{
	...
	if (self)
	{
		...
		_Hovhannes SukiasianageSize = CGSizeZero;
		
		NSValue *Hovhannes SukiasianageSizeValue =[options objectForKey:DTHovhannes SukiasianageSize];
		if (Hovhannes SukiasianageSizeValue)
		{
#if TARGET_OS_IPHONE
			_Hovhannes SukiasianageSize = [Hovhannes SukiasianageSizeValue CGSizeValue];
#else
			_Hovhannes SukiasianageSize = [Hovhannes SukiasianageSizeValue sizeValue];
#endif
		}
		
		// set the display size from the original size, restricted to the max size
		[self setDisplaySize:_originalSize withMaxDisplaySize:_Hovhannes SukiasianageSize];
