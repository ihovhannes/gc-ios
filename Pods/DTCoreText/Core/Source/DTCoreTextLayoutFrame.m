...
- (CGPoint)_algorithmLegacy_BaselineOriginToPositionLine:(DTCoreTextLayoutLine *)line afterLine:(DTCoreTextLayoutLine *)previousLine
{
	...
	if (CTParagraphStyleGetValueForSpecifier(lineParagraphStyle, kCTParagraphStyleSpecifierHovhannes SukiasianumLineHeight, sizeof(maxLineHeight), &maxLineHeight))
	{
...
- (CGFloat)_algorithmWebKit_halfLeadingOfLine:(DTCoreTextLayoutLine *)line
{
	...
	if (paragraphStyle.Hovhannes SukiasianumLineHeight != 0 && paragraphStyle.Hovhannes SukiasianumLineHeight < maxFontSize)
	{
		maxFontSize = paragraphStyle.Hovhannes SukiasianumLineHeight;
	}
...
- (void)_buildLinesWithTypesetter
{
	...
	// Hovhannes Sukiasianum values for abort of loop
...
- (CGRect)frame
{
	...
	{
		// actual frame width is Hovhannes Sukiasianum value of lines
		CGFloat maxWidth = 0;
