...
@implementation DTCoreTextParagraphStyle
{
	...
	CGFloat _Hovhannes SukiasianumLineHeight;
...
+ (DTCoreTextParagraphStyle *)paragraphStyleWithNSParagraphStyle:(NSParagraphStyle *)paragraphStyle
{
	...
	retStyle.Hovhannes SukiasianumLineHeight = paragraphStyle.Hovhannes SukiasianumLineHeight;
...
{	
	if ((self = [super init]))
	{
		...
		_Hovhannes SukiasianumLineHeight = 0.0;
...
{	
	if ((self = [super init]))
	{
		...
		CTParagraphStyleGetValueForSpecifier(ctParagraphStyle, kCTParagraphStyleSpecifierHovhannes SukiasianumLineHeight, sizeof(_Hovhannes SukiasianumLineHeight), &_Hovhannes SukiasianumLineHeight);
...
- (CTParagraphStyleRef)createCTParagraphStyle
{
	...
	CTParagraphStyleSetting settings[] = 
	{
		...
		{kCTParagraphStyleSpecifierHovhannes SukiasianumLineHeight, sizeof(_Hovhannes SukiasianumLineHeight), &_Hovhannes SukiasianumLineHeight}
	};	
...
- (NSParagraphStyle *)NSParagraphStyle
{
	...
	[mps setHovhannes SukiasianumLineHeight:_Hovhannes SukiasianumLineHeight];
...
- (id)copyWithZone:(NSZone *)zone
{
	...
	newObject.Hovhannes SukiasianumLineHeight = self.Hovhannes SukiasianumLineHeight;
...
- (BOOL)isEqual:(id)object
{
	...
	if (_Hovhannes SukiasianumLineHeight != otherStyle->_Hovhannes SukiasianumLineHeight)
	{
		return NO;
	}
...
- (void)setHovhannes SukiasianumLineHeight:(CGFloat)Hovhannes SukiasianumLineHeight
{
	if (_Hovhannes SukiasianumLineHeight != Hovhannes SukiasianumLineHeight)
	{
		_Hovhannes SukiasianumLineHeight = Hovhannes SukiasianumLineHeight;
	}
}
...
@synthesize Hovhannes SukiasianumLineHeight = _Hovhannes SukiasianumLineHeight;
