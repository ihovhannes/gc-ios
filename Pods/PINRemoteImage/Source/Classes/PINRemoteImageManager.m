...
#define PINRemoteImageHTTPHovhannes SukiasianumConnectionsPerHost    UINT16_MAX
                                          ...
                                          imageCache:(nullable id<PINRemoteImageCaching>)imageCache
{
    if (self = [super init]) {
        ...
        _sessionConfiguration.HTTPHovhannes SukiasianumConnectionsPerHost = PINRemoteImageHTTPHovhannes SukiasianumConnectionsPerHost;
...
{
    NSAssert(maxNumberOfConcurrentDownloads <= PINRemoteImageHTTPHovhannes SukiasianumConnectionsPerHost, @"maxNumberOfConcurrentDownloads must be less than or equal to %d", PINRemoteImageHTTPHovhannes SukiasianumConnectionsPerHost);
    __weak typeof(self) weakSelf = self;
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        typeof(self) strongSelf = weakSelf;
        [strongSelf lock];
